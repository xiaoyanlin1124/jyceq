...
//        System.out.println(t.demoDeleteAllTokensOfAccount());
    ...
    public static void demoXingeSimple() {
        // 易用接口
        System.out.println(XingeApp.pushTokenAndroid(2100297185, "af20bdea534492c9de400248b0475de6", "test", "测试", "3d72a1e063cffba94fcda8ad61fe26bf87a2611a"));
    ...
    protected JSONObject demoPushSingleDeviceMessage() {
        ...
        JSONObject ret = xinge.pushSingleDevice("3d72a1e063cffba94fcda8ad61fe26bf87a2611a", message);
    ...
    protected JSONObject demoPushSingleDeviceNotification() {
        JSONObject ret = xinge.pushSingleDevice("3d72a1e063cffba94fcda8ad61fe26bf87a2611a", message1);
        return ret;
    }
    ...
    protected JSONObject demoQueryTokenTags() {
        JSONObject ret = xinge.queryTokenTags("3d72a1e063cffba94fcda8ad61fe26bf87a2611a");
        return ret;
    }
    ...
    protected JSONObject demoQueryInfoOfToken() {
        JSONObject ret = xinge.queryInfoOfToken("3d72a1e063cffba94fcda8ad61fe26bf87a2611a");
        return ret;
    }
    ...
    public Demo() {
        XingeApp xinge = new XingeApp(2100297185, "af20bdea534492c9de400248b0475de6 ");
        buildMesssges();
    }
